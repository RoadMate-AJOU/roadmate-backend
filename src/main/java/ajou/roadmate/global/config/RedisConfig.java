...
public class RedisConfig {
    ...
    @Bean
    public RedisTemplate<String, ChatContext> chatContextRedisTemplate(RedisConnectionFactory factory) {
        RedisTemplate<String, ChatContext> template = new RedisTemplate<>();
